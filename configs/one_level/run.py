...
parser.add_option("--output", help="Output file for dct application", default="")
...
parser.add_option("--output", help="Output file", default="")
...
parser.add_option("--output", help="Output file", default="output.txt")
