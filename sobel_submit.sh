...
python3 random_injection.py --bench-name=sobel --sobel-input=/cta/users/masoyturk/FaultModel/gem5/tests/test-progs/sobel/figs/input.grey --sobel-output=/cta/users/masoyturk/FaultModel/gem5/tests/test-progs/sobel/golden.bin
RET=$?
